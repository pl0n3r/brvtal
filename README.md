...
| Git delta | 📐 **10 files · 235 insertions · 92 deletions · net +143** | base `1cb65b32ff99f07fce1a5748d380c0c9587e5949` → head del PR |
...
- `tests/project-operations-contract.php` — alinea el agregador final `validate` con `preflight` + gates aplicables.
