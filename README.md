...
- `tests/e2e/content-core-real-stack.spec.mjs` — stale Dashboard y navegación cross-module aislados sobre el shell autenticado real.
- `tests/e2e/discadmin-content-ordering.spec.mjs` — teclado, touch, rollback, filtros y stores con observer aislado en el harness.
