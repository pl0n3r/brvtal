(() => {
  ...
  const coreScripts = ['js/menu-scroll-lock.js', 'js/app.js', 'js/public-roster.js', 'js/public-sets-library.js', 'js/archive.js', 'js/public-media.js', 'js/public-memory-relations.js'];
