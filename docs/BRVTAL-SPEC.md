...
- Production entity routes and preview render through the same `brvtalPublicEntityDocument()` delivery path. Preview may replace the data source, never the public component/template path.
