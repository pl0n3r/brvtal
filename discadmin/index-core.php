...
.modal{position:fixed;inset:0;background:rgba(0,0,0,.88);backdrop-filter:blur(8px);display:none;align-items:center;justify-content:center;padding:18px;z-index:50}.modal.open{display:flex}.modalbox{width:min(1100px,100%);max-height:94vh;overflow:auto;background:#080909;border:1px solid #30353a}.modalhead{display:flex;justify-content:space-between;align-items:center;padding:20px 24px;border-bottom:1px solid #24282c}.modalhead h2{margin:0;font-size:20px}.micro{font-size:9px;letter-spacing:2px;color:#70767c;margin-top:5px}.form{padding:24px}.section{border:1px solid #24282c;background:#0a0b0c;padding:20px;margin-bottom:15px}.sectionhead{display:flex;justify-content:space-between;border-bottom:1px solid #24282c;padding-bottom:12px;margin-bottom:18px}.sectionhead strong{font-size:10px;letter-spacing:2px}.helper{font-size:10px;color:#747b82;line-height:1.5}.grid2{display:grid;grid-template-columns:1fr 1fr;gap:14px}.field{margin-bottom:14px}.field label{display:block;color:#8b9197;font-size:9px;text-transform:uppercase;letter-spacing:1.4px;margin-bottom:7px}.field input,.field textarea,.field select{width:100%;background:#050606;border:1px solid #353a3f;color:#fff;padding:11px}.membership-check{display:flex;gap:12px;align-items:flex-start;border:1px solid #353a3f;background:#050606;padding:14px}.membership-check input{width:auto!important;min-height:0!important;margin:2px 0 0;accent-color:var(--green)}.membership-check span{display:grid;gap:5px}.membership-check b{font-size:11px;letter-spacing:.5px}.membership-check small{color:#747b82;font-size:10px;line-height:1.5}.field textarea{min-height:110px;resize:vertical}.full{grid-column:1/-1}.modalfoot{display:flex;justify-content:space-between;align-items:center;border-top:1px solid #25292d;padding:16px 24px}.footactions{display:flex;gap:8px}.notice{display:none;margin:0 24px 10px;padding:11px;border:1px solid #3a3f44;font-size:11px}.notice.show{display:block}.error{color:#ff5555}
...
function checkbox(id,label,checked=false,help=''){return `<div class="field full"><label for="f_${id}">${label}</label><label class="membership-check" for="f_${id}"><input id="f_${id}" type="checkbox" ${checked?'checked':''}><span><b>${label}</b><small>${help}</small></span></label></div>`}
