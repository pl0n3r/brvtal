...
<section id="eventsTab" class="panel"><div class="toolbar"><label class="admin-sr-only" for="eventSearch">Search events</label><input id="eventSearch" class="search" placeholder="Search events…"><div class="head-actions"><button class="btn" onclick="BRVTALContentCore.loadEvents()">REFRESH</button><button class="btn green" onclick="BRVTALContentCore.openEvent()">+ NEW EVENT</button></div></div><div id="eventsTable" class="table"></div></section>
<section id="rosterTab" class="panel" style="display:none"><div class="toolbar"><label class="admin-sr-only" for="artistSearch">Search artists</label><input id="artistSearch" class="search" placeholder="Search artists…"><button class="btn" onclick="BRVTALContentCore.loadArtists()">REFRESH</button></div><div class="roster"><div class="box"><h3>COLLECTIVE ROSTER</h3><div class="helper">Manage active BRVTAL DJs and alumni without changing the artist identity itself.</div><div id="rosterList" class="artist-list" style="margin-top:12px"></div></div><div class="box"><h3>ARTIST LIFECYCLE</h3><div id="artistDetail" class="helper">Select an artist to edit collective status and order.</div></div></div></section>
</div>
<div id="eventModal" class="modal"><div class="modalbox"><div class="modalhead"><div><div class="ey">CONTENT CORE / EVENT</div><h2 id="eventHeading">NEW EVENT</h2></div><div class="modal-actions" style="display:flex;gap:8px;align-items:center"><button id="cc-top-saveBtn" type="button" class="btn red" onclick="BRVTALContentCore.saveEvent()">SAVE</button><button class="icon" type="button" onclick="BRVTALContentCore.closeEvent()">CLOSE</button></div></div><div id="eventNotice" class="notice"></div><div class="wizard"><div class="steps"><div class="step active" data-step="1">01 · IDENTITY</div><div class="step" data-step="2">02 · DATE & PLACE</div><div class="step" data-step="3">03 · LIFECYCLE</div><div class="step" data-step="4">04 · TICKETS</div><div class="step" data-step="5">05 · ROSTER</div></div><div class="wizard-main">
<form id="eventForm" onsubmit="return false">
<div class="step-content active" data-content="1"><div class="section"><div class="sectionhead"><strong>EVENT IDENTITY</strong><span class="helper">Save incomplete content at any time.</span></div><div class="form"><div class="field"><label for="e_title">Name *</label><input id="e_title"></div><div class="field"><label for="e_slug">Slug</label><input id="e_slug" placeholder="Generated automatically"></div><div class="field full"><label for="e_description">Description</label><textarea id="e_description"></textarea></div><div class="field"><label for="e_cover_image">Cover image</label><input id="e_cover_image" placeholder="Media path / URL"></div><div class="field"><label for="e_accent">Accent</label><input id="e_accent" placeholder="#ff2038"></div><div class="field"><label for="e_featured">Featured</label><select id="e_featured"><option value="0">No</option><option value="1">Yes</option></select></div></div></div></div>
<div class="step-content" data-content="2"><div class="section"><div class="sectionhead"><strong>DATE & PLACE</strong></div><div class="form"><div class="field"><label for="e_event_date">Date & time *</label><input id="e_event_date" type="datetime-local"></div><div class="field"><label for="e_city">City *</label><input id="e_city"></div><div class="field"><label for="e_venue">Venue</label><input id="e_venue"></div><div class="field"><label for="e_archive_year">Archive year</label><input id="e_archive_year" type="number" min="2000" max="2200"></div></div></div></div>
<div class="step-content" data-content="3"><div class="section"><div class="sectionhead"><strong>LIFECYCLE</strong></div><div class="form"><div class="field"><label for="e_status">Status</label><select id="e_status"><option>draft</option><option>published</option><option>upcoming</option><option>tickets_available</option><option>last_tickets</option><option>sold_out</option><option>cancelled</option><option>finished</option><option>archived</option></select></div><div class="field"><label for="e_ticket_instructions">Ticket instructions</label><textarea id="e_ticket_instructions"></textarea></div><div class="field"><label for="e_ticket_qr">Ticket QR</label><input id="e_ticket_qr"></div><div class="field"><label for="e_ticket_url">External ticket URL</label><input id="e_ticket_url"></div></div></div></div>
