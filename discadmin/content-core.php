    ...
    <div class="form">
      ...
      <div class="field" data-admin-color-field data-color-default="#ff2038">
        ...
        <div class="admin-color-field__controls">
          <input id="e_accent" data-color-hex placeholder="#ff2038" maxlength="7" pattern="#[0-9A-Fa-f]{6}" inputmode="text" autocomplete="off" spellcheck="false" aria-describedby="e_accent_help e_accent_error">
          <input id="e_accent_picker" class="admin-color-field__picker" data-color-picker type="color" value="#ff2038" aria-label="Choose Event Accent visually">
        </div>
        ...
        <div id="e_accent_error" class="admin-color-field__error" data-color-error hidden>Use a 6-digit HEX value such as #ff2038.</div>
      </div>
      <div class="field">
