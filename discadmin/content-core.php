...
<div id="eventModal" class="modal"><div class="modalbox"><div class="modalhead"><div><div class="ey">CONTENT CORE / EVENT</div><h2 id="eventHeading">NEW EVENT</h2></div><div class="modal-actions"><button id="cc-top-saveBtn" type="button" class="btn red" onclick="BRVTALContentCore.saveEvent()">SAVE</button><button class="icon" type="button" onclick="BRVTALContentCore.closeEvent()">CLOSE</button></div></div><div id="eventNotice" class="notice"></div><div class="wizard"><div class="steps"><button type="button" class="step active" data-step="1">01 · IDENTITY</button><button type="button" class="step" data-step="2">02 · DATE & PLACE</button><button type="button" class="step" data-step="3">03 · LIFECYCLE</button><button type="button" class="step" data-step="4">04 · TICKETS</button><button type="button" class="step" data-step="5">05 · ROSTER</button></div><div class="wizard-main">
