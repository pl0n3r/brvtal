...
const coreAndEnhancements = ['menu-scroll-lock', 'app', 'roster', 'sets-library', 'transmissions', 'archive', 'media', 'menu-accessibility', 'input-accessibility', 'mobile-events', 'hero-slider', 'url-state', 'canonical-navigation', 'contact', 'theme-runtime', 'theme-branding-sync'];
