...
async function mount(page) {
  ...
  await page.route('**/api/dashboard-overview.php', route => route.fulfill({contentType:'application/json',body:JSON.stringify({ok:true,data:{summary:{public_records:1,draft_records:1,active_events:0,media_assets:2},next_event:null}})}));
  ...
  await expect(page.locator('#brvtal-dashboard-v2')).toBeVisible();
}
