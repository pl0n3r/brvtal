...
test('related content explorer connects artists to events, sets and releases without a separate page', async ({ page }) => {
  const data = {
    events: [
      { id: 10, title: 'NEXT SIGNAL', event_date: '2026-10-03 21:00:00', city: 'Pereira', venue: 'Warehouse', status: 'tickets_available', cover_image: '/next.jpg' },
    ],
    archive: {
      events: [
        { id: 11, title: 'PAST SIGNAL', event_date: '2026-08-07 21:00:00', city: 'Pereira', venue: 'Studio', status: 'finished', cover_image: '/past.jpg' },
      ],
    },
    artists: [
      { id: 1, name: 'PL0N3R', bio: 'HARD TECHNO', photo: '/artist-one.jpg' },
      { id: 2, name: 'DNL5', bio: 'INDUSTRIAL', photo: '/artist-two.jpg' },
    ],
    sets: [
      { id: 20, title: 'PL0N3R LIVE', artist_id: 1, artist_name: 'PL0N3R', event_id: 10, event_title: 'NEXT SIGNAL', platform: 'soundcloud', external_url: 'https://sound.example/pl0n3r' },
    ...
    releases: [
      { id: 30, title: 'SIGNAL 001', release_type: 'single', release_date: '2026-09-01', spotify_url: 'https://music.example/signal', artwork: '/release.jpg' },
    ],
    relations: {
      events: {
  ...
  await expect(page.locator('a[href="https://music.example/signal"]')).toBeVisible();
