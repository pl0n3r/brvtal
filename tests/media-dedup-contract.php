...
media_dedup_assert(str_contains($api, 'brvtalMediaCleanupFailedUploadOrThrow($absolute, $e);'), 'losing concurrent upload must remove or privately quarantine its moved orphan');
