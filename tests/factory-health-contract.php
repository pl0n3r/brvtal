...
$nonExact = brvtalFactoryReadinessState(false, $sha, $healthyStatus);
...
$mismatchedSchema = brvtalFactoryReadinessState(true, $sha, $status([
    $applied('migration_schema_migrations_01.sql'),
...
$orphanedSchema = brvtalFactoryReadinessState(
    true,
    $sha,
...
$summary = brvtalMigrationReadinessSummary($status([
    $applied('migration_schema_migrations_01.sql'),
    $pending('migration_pending_01.sql'),
    $mismatch('migration_existing_01.sql'),
